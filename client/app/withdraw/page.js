...
export default function Withdraw() {
    ...
    const { connectedAccount, checkBalance, withdraw} = useWeb3();
    ...
    const withdrawEth = async () => {
        ...
        console.log(mybalance, 'after withdraw')
      }
    ...
    return (
      ...
      <div className="bg-white bg-opacity-50 backdrop-filter backdrop-blur-lg rounded-lg p-8 shadow-lg">
        ...
        />
        <button className="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-700" onClick={withdrawEth}>
          Submit
        </button>
      </div>
    </div>
